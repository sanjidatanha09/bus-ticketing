...
const ImageModal = ({ isOpen, setIsOpen }) => {
  const { modalImage } = useContext(BusProvider);
      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="fixed inset-0 bg-primary1 bg-opacity-50 backdrop-blur-sm" />
          </Transition.Child>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center relative">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-none bg-primary1 text-left align-middle shadow-xl transition-all">
                  <div
