...
const UnUnitModal = ({ isOpen, setIsOpen }) => {
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto z-50">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-sm bg-primary3 p-6 text-left align-middle shadow-xl transition-all z-50">
                  <div
                    onClick={() => setIsOpen(false)}
                    className="absolute right-0 -top-1 hover:cursor-pointer"
                  >
                    <FaRegWindowClose className="text-3xl text-primary2" />
                  </div>
                  <Dialog.Title
                    as="h3"
                  ...
                  {loading ? (
                    ...
                    <div className="mt-8 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-5 mx-auto w-full">
